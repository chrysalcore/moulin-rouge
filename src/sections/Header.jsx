...
function Header() {
    ...
    return (
        <section className='header'>
            <img className='header__logo' src="/src/assets/icons/logo.svg" alt="main icon"/>
            <Nav navDetails={sectNav} />
            <div className='header-buttons'>
                <button className='header__button-log'>Login</button>
                <button className='header__button-user'>
                    <svg aria-label='user button' className='user-icon' data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.47 20.96">
